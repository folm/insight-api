...
BlockController.prototype.getBlockReward = function (height) {
    var subsidy = new BN(0 * 1e8);
    var nSlowSubsidy = 45;
    var nRampToblock = 500;
    if (height == 1) {
        subsidy = new BN(1136956 * 1e8);
    }
    else if (height < nRampToblock) {
        nSlowSubsidy = nSlowSubsidy / nRampToblock * height;
        subsidy = new BN(nSlowSubsidy * 1e8);
    }
    else if (height <= 262800 && height >= nRampToblock) {
        subsidy = new BN(45 * 1e8);
    } else if (height <= 525600 && height > 262800) {
        subsidy = new BN(40 * 1e8);
    }
    else if (height <= 788400 && height > 525600) {
        subsidy = new BN(25 * 1e8);
    }
    else if (height <= 1051200 && height > 788400) {
        subsidy = new BN(15 * 1e8);
    }
    else if (height <= 1314000 && height > 1051200) {
        subsidy = new BN(10 * 1e8);
    }
    else if (height <= 1576800 && height > 1314000) {
        subsidy = new BN(6.65 * 1e8);
    }
    else if (height <= 1839600 && height > 1576800) {
        subsidy = new BN(5.3 * 1e8);
    }
    else if (height <= 2102400 && height > 1839600) {
        subsidy = new BN(3.75 * 1e8);
    }
    else if (height > 2102400) {
        subsidy = new BN(2.5 * 1e8);
    }
